...
| DOC-01 | `docs/DOC-01-delivery` | Claude | REVIEW | 2026-09-14 | 见 PR | 无（交付材料在根目录，不受 Git 管理） | 后端 `a2b6f48`；README 重写为导入与联调说明（导入路径、AppID、urlCheck、双角色演示数据、管理台五区域）；静态 6/6、Node 138/138 复验通过 | 2026-09-14 |
